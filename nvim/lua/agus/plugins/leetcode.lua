return {
    ...
    build = ":TSUpdate html",
    dependencies = {
        "nvim-telescope/telescope.nvim", "MunifTanjim/nui.nvim", -- optional
    ...
    config = function()
        ...
        local storage = function(selected_lang)
            local defined_storages = {
                rust = vim.fn.stdpath("data") ..
                    "/leetcode/solutions/rust/src/bin"
            }
